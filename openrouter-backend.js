...
app.post('/corregir', async (req, res) => {
    ...
    const prompt = `Eres un profesor de biología de 1º de ESO. Aquí tienes una pregunta de desarrollo: "${pregunta}".\n\nRespuesta modelo: ${respuestaModelo}\n\nRespuesta del alumno: ${respuestaUsuario}\n\nHaz una corrección constructiva: di si la respuesta es correcta o no, qué le falta, qué podría mejorar, y si está bien, felicita al alumno. Responde en español.`;
    try {
